...
# ============================================================================
# TABLE OF CONTENTS
#  - SECTION: Prompt Layout — Left
#  - SECTION: Prompt Layout — Right
#  - SECTION: General Prompt Behavior & Colors
#  - SECTION: Prompt Symbols, Separators & Icons
#  - SECTION: OS Icon
#  - SECTION: Directory Segment
#  - SECTION: Git / VCS Segment
#  - SECTION: System Status Segments
#  - SECTION: Misc & Visual Identifiers
#  - SECTION: Shell / Editing State
#  - SECTION: Cloud, Containers & Remote Context
#  - SECTION: Python Segment
#  - SECTION: Other Language/Runtime Segments
#  - SECTION: Node.js Segment
# ============================================================================
...
typeset -g POWERLEVEL9K_CUSTOM_RAM_BACKGROUND='236'
